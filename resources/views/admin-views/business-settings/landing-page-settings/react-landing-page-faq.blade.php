                                            ...
                                            <div class="card">
                                                <div class="card-header-cus" id="headingOne01">
                                                    <button class="btn btn-link text-wrap text-title" type="button"
                                                        ...
                                                        How do I place an order on umbrella from start to finish?
                                                    </button>
                                                </div>
                                                ...
                                                <div id="collapseOne01" class="collapse show" aria-labelledby="headingOne01"
                                                    ...
                                                    <div class="card-body max-w-700 pt-0">
                                                        To place an order, open the umbrella app or website, browse or search for the products you need, and add them to your cart. At checkout, enter your delivery address and payment details, then confirm your order to complete the process.
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card">
                                                ...
                                                <div id="collapseTwo02" class="collapse" aria-labelledby="headingTwo02"
                                                     data-parent="#faqAccordion2">
                                                    <div class="card-body max-w-700 pt-0">
                                                        To place an order, open the umbrella app or website, browse or search
                                                        for
