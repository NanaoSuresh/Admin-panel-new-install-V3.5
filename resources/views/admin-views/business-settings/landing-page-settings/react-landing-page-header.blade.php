                    ...
                    <div class="common-section-inner cus-gradient rounded-10">
                        <div class="py-sm-5 py-3 px-sm-4 px-2 text-center">
                            ...
                            <p class="text-title fs-14 mb-xl-4 mb-lg-4 mb-3">
                                {{ $header_sub_title?->value ?? 'Enter your address to enjoy fast delivery of groceries, food, medicine, parcels & more from your favorite local stores with umbrella.' }}
                            </p>
